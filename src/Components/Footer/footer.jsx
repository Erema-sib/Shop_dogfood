        ...
        <div className="footer_wrapper">
          ...
          <div className="footer_col">
            <nav className="menu-bottom">
              <a href="/catalogue" className="menu-bottom_item">
                Каталог
              </a>
              <a href="/catalogue" className="menu-bottom_item">
                Акции
          ...
          <div className="footer_col">
            <div className="contacts">
              ...
              <a className="contacts_tel contacts__link" href="tel:8999000000">
                8 (999) 00-00-00
              </a>
              <a
                className="contacts_mail contacts_link"
              ...
              <ul className="socials contacts_socials">
                ...
                <li className="socials_item">
                  <a className="socials_link" href="/#">
                    <img src={viber} alt="viber" className="socials_icon" />
                  </a>
                </li>
                ...
                <li className="socials_item">
                  <a className="socials_link" href="/#">
                    <img src={vk} alt="vk" className="socials_icon" />
                  </a>
                </li>
              </ul>
            </div>
