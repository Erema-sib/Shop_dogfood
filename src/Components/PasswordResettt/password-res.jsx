...
const PasswodrdRes = () => {
  ...
  return (
    <Form
      ...
      handleFormSubmit={handleSubmit(HzRegApi)}
    >
      <p className="infoText">
        Для получение временного пароля необходимо ввести e-mail, указанный при
        регистрации.
      </p>
      <FormInput
        {...emailRegister}
      ...
      <p className="infoText">Срок дейсвия временного пароля 24ч.</p>
