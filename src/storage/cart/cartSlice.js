...
const cartSlice  = createSlice({
  ...
  reducers: { 
      addCart: (state, action) => {
        const productCart = state.data.find(product => product._id === action.payload._id);
        if (productCart) {
...
export const { addCart, increaseByOne, decreaseByOne, removeProduct, addCartAfterChange } = cartSlice.actions;
